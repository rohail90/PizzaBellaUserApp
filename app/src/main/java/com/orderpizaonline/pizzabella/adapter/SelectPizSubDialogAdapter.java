...
public class SelectPizSubDialogAdapter extends RecyclerView.Adapter<SelectPizSubDialogAdapter.ViewHolder>  {

    private List<PairValuesModel> mList = new ArrayList<>();
    private Context mContext;
    private int index = 0;
    public SelectPizSubDialogAdapter(List<PairValuesModel> mList, Context context) {
        this.mList = mList;
    ...
    @NonNull
    @Override
    public SelectPizSubDialogAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

            View view = LayoutInflater.from(mContext).inflate(R.layout.sub_dialog_item,parent,false);
            return new SelectPizSubDialogAdapter.ViewHolder(view);
        }


    @Override
    public void onBindViewHolder(@NonNull SelectPizSubDialogAdapter.ViewHolder holder, final int position) {
        ...
        holder.cl_sub_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                selectPizItm.setName(mList.get(position).getName());
            }
        });
