...
public class ComboDialogAdapter extends RecyclerView.Adapter<ComboDialogAdapter.ViewHolder>  {

    private List<ComboInfo> mList = new ArrayList<>();
    private Context mContext;
    private int index = 0;
    public ComboInfo selectedCombo = new ComboInfo();
    public ComboDialogAdapter(List<ComboInfo> mList, Context context) {
        this.mList = mList;
    ...
    @NonNull
    @Override
    public ComboDialogAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {


            View view = LayoutInflater.from(mContext).inflate(R.layout.combo_item,parent,false);

            return new ComboDialogAdapter.ViewHolder(view);
        }



    @Override
    public void onBindViewHolder(@NonNull ComboDialogAdapter.ViewHolder holder, final int position) {
        if (index == position){
...
/*    private void showActonDialog(final int itemPosition) {
    ...
    public void setData(List<ComboInfo> bottelList) {
        this.mList.clear();
