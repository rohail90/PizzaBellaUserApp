...
public class SidelinesOrderDetailsHolder extends RecyclerView.ViewHolder {
    ...
    public SidelinesOrderDetailsHolder(@NonNull View itemView, List<SidelineOrderInfo> mList, Context context) {
        super(itemView);
