...
import static com.orderpizaonline.pizzabella.fragments.ShowPizzasFragment.setSizePrice;

public class SubDialogAdapter extends RecyclerView.Adapter<SubDialogAdapter.ViewHolder>  {

    private List<PairValuesModel> mList = new ArrayList<>();
    private Context mContext;
    private int index = 0;
    public SubDialogAdapter(List<PairValuesModel> mList, Context context) {
        this.mList = mList;
    ...
    @NonNull
    @Override
    public SubDialogAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

            View view = LayoutInflater.from(mContext).inflate(R.layout.sub_dialog_item,parent,false);
            return new SubDialogAdapter.ViewHolder(view);
        }


    @Override
    public void onBindViewHolder(@NonNull SubDialogAdapter.ViewHolder holder, final int position) {
        ...
        holder.cl_sub_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                setSizePrice(mList.get(position));
            }
        });
