...
public class DealOrderDetailsHolder extends RecyclerView.ViewHolder {
    ...
    public DealOrderDetailsHolder(@NonNull View itemView, List<ComboOrderInfo> mList, Context context) {
        super(itemView);
