...
public class PremiumToppingsAdapter extends RecyclerView.Adapter<PremiumToppingsAdapter.ViewHolder>  {

    private List<PizzaToppingInfo> mList = new ArrayList<>();
    private Context mContext;
    public PremiumToppingsAdapter(List<PizzaToppingInfo> mList, Context context) {
        this.mList = mList;
    ...
    @NonNull
    @Override
    public PremiumToppingsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(mContext).inflate(R.layout.topping_item,parent,false);
            return new PremiumToppingsAdapter.ViewHolder(view);
        }


    @Override
    public void onBindViewHolder(@NonNull PremiumToppingsAdapter.ViewHolder holder, final int position) {
