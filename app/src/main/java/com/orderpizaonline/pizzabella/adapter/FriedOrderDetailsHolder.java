...
public class FriedOrderDetailsHolder extends RecyclerView.ViewHolder {
    ...
    public FriedOrderDetailsHolder(@NonNull View itemView, List<FriedRollOrderInfo> mList, Context context) {
        super(itemView);
