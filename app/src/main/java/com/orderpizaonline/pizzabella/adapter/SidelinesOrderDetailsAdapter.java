...
public class SidelinesOrderDetailsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<SidelineOrderInfo> mList = new ArrayList<>();
    private Context context;

    public SidelinesOrderDetailsAdapter(Context context, List<SidelineOrderInfo> mList) {
        this.mList = mList;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new SidelinesOrderDetailsHolder(view , mList, context);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        int size= mList.size();
        ((SidelinesOrderDetailsHolder)holder).bindData(mList.get(position),position,size);
