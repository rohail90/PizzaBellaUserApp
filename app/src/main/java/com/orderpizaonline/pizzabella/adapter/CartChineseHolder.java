...
import static com.orderpizaonline.pizzabella.fragments.CartCheckoutFragment.ordersChinese;
import static com.orderpizaonline.pizzabella.fragments.CartCheckoutFragment.setTotalCartPrice;


public class CartChineseHolder extends RecyclerView.ViewHolder {
    ...
    public CartChineseHolder(@NonNull View itemView, List<ChineseCornerOrderInfo> mList, Context context) {
        super(itemView);
       ...
       // image.setImageDrawable(context.getResources().getDrawable(R.drawable.soft_drink));
        plus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ordersChinese.get(position).setQuantity(q);
                new DBClass(context).UpdateChineseQuantity(achievementModel.getId(),q);
                quantity.setText(q+"");
                totalPrice.setText( (q * mList.get(position).getSinglePrice()) +"");
                ordersChinese.get(position).setTotalPrice(q * mList.get(position).getSinglePrice() );
                setTotalCartPrice();
            }
        });
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog_ok_txt.setOnClickListener(vi -> {
                    ...
                    new DBClass(context).DeleteChinese(achievementModel.getId());
                    setTotalCartPrice();
                    rateus_dialog.dismiss();
                });
