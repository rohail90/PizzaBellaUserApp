...
import static com.orderpizaonline.pizzabella.fragments.ShowFriedRollFragment.setAddOn;

public class SelectFriedRollAddOnDialogAdapter extends RecyclerView.Adapter<SelectFriedRollAddOnDialogAdapter.ViewHolder>  {

    private List<PairValuesModel> mList = new ArrayList<>();
    private Context mContext;
    private int index = 0;
    public SelectFriedRollAddOnDialogAdapter(List<PairValuesModel> mList, Context context) {
        this.mList = mList;
    ...
    @NonNull
    @Override
    public SelectFriedRollAddOnDialogAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

            View view = LayoutInflater.from(mContext).inflate(R.layout.sub_dialog_item,parent,false);
            return new SelectFriedRollAddOnDialogAdapter.ViewHolder(view);
        }


    @Override
    public void onBindViewHolder(@NonNull SelectFriedRollAddOnDialogAdapter.ViewHolder holder, final int position) {
