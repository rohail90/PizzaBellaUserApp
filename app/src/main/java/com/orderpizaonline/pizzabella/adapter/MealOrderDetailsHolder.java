...
public class MealOrderDetailsHolder extends RecyclerView.ViewHolder {
    ...
    public MealOrderDetailsHolder(@NonNull View itemView, List<ComboOrderInfo> mList, Context context) {
        super(itemView);
    ...
    public void bindData(final ComboOrderInfo achievementModel, final int position, int size) {
        ...
        totalPrice.setText(achievementModel.getTotalPrice()* achievementModel.getQuantity() +"");
