...
public class SelectedChineseAdapter extends RecyclerView.Adapter<SelectedChineseAdapter.ViewHolder>  {

    private List<ChineseCornerOrderInfo> mList = new ArrayList<>();
    private Context mContext;
    public SelectedChineseAdapter(List<ChineseCornerOrderInfo> mList, Context context) {
        this.mList = mList;
    ...
    @NonNull
    @Override
    public SelectedChineseAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {


            View view = LayoutInflater.from(mContext).inflate(R.layout.cart_sidelines_list_item,parent,false);

            return new SelectedChineseAdapter.ViewHolder(view);
        }



    @Override
    public void onBindViewHolder(@NonNull SelectedChineseAdapter.ViewHolder holder, final int position) {
