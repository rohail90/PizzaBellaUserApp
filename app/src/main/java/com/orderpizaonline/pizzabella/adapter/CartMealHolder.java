...
import static com.orderpizaonline.pizzabella.fragments.CartCheckoutFragment.ordersMeal;
import static com.orderpizaonline.pizzabella.fragments.CartCheckoutFragment.setTotalCartPrice;


public class CartMealHolder extends RecyclerView.ViewHolder {
    ...
    public CartMealHolder(@NonNull View itemView, List<ComboOrderInfo> mList, Context context) {
        super(itemView);
    ...
    public void bindData(final ComboOrderInfo achievementModel, final int position, int size) {
        ...
        name.setText(achievementModel.getDealDescription());
       ...
       // image.setImageDrawable(context.getResources().getDrawable(R.drawable.soft_drink));
        plus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ordersMeal.get(position).setQuantity(q);
                new DBClass(context).UpdateMealQuantity(achievementModel.getId(),q);
                quantity.setText(q+"");
                totalPrice.setText( (q * Integer.parseInt(mList.get(position).getPrice())) +"");
                ordersMeal.get(position).setTotalPrice(q * Integer.parseInt(mList.get(position).getPrice()) );
                setTotalCartPrice();
            }
        });
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog_ok_txt.setOnClickListener(vi -> {
                    ...
                    new DBClass(context).DeleteMeal(achievementModel.getId());
                    setTotalCartPrice();
                    rateus_dialog.dismiss();
                });
