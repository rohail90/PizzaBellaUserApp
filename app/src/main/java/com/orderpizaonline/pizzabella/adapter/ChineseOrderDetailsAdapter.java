...
public class ChineseOrderDetailsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<ChineseCornerOrderInfo> mList = new ArrayList<>();
    private Context context;

    public ChineseOrderDetailsAdapter(Context context, List<ChineseCornerOrderInfo> mList) {
        this.mList = mList;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ChineseOrderDetailsHolder(view , mList, context);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        int size= mList.size();
        ((ChineseOrderDetailsHolder)holder).bindData(mList.get(position),position,size);
