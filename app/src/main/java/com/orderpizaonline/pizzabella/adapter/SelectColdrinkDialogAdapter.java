...
import static com.orderpizaonline.pizzabella.fragments.ShowBeveragesFragment.setCodrinkSizePrice;

public class SelectColdrinkDialogAdapter extends RecyclerView.Adapter<SelectColdrinkDialogAdapter.ViewHolder>  {

    private List<PairValuesModel> mList = new ArrayList<>();
    private Context mContext;
    private int index = 0;
    public SelectColdrinkDialogAdapter(List<PairValuesModel> mList, Context context) {
        this.mList = mList;
    ...
    @NonNull
    @Override
    public SelectColdrinkDialogAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

            View view = LayoutInflater.from(mContext).inflate(R.layout.sub_dialog_item,parent,false);
            return new SelectColdrinkDialogAdapter.ViewHolder(view);
        }


    @Override
    public void onBindViewHolder(@NonNull SelectColdrinkDialogAdapter.ViewHolder holder, final int position) {
        ...
        holder.cl_sub_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                setCodrinkSizePrice(mList.get(position));
            }
        });
