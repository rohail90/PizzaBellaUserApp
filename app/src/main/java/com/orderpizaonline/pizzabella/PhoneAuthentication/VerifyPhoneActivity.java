...
import com.orderpizaonline.pizzabella.ui.ForgotPasswordActivity;
import com.orderpizaonline.pizzabella.ui.SignupActivity;
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (getIntent().getBooleanExtra("isForgot",false)){
                                ...
                                Intent intent = new Intent(VerifyPhoneActivity.this, ForgotPasswordActivity.class);
