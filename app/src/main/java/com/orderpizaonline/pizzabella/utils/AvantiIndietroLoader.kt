...
class AvantiIndietroLoader @JvmOverloads constructor(
    ...
    private val shadowY = 6f
    private val shadowRadius = 4.5f
    ...
    private fun initColorsAndPoints() {
        ...
        initialColors[1] = ContextCompat.getColor(context, R.color.firstCircleColor)
        initialPoints[1].x = canvasWidth / 2f + -2 * dpToPx(radius) - dpToPx(distance)
        initialPoints[1].y = canvasHeight / 2f

        initialColors[2] = ContextCompat.getColor(context, R.color.secondCircleColor)
